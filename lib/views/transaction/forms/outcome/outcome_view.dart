...
class OutcomeView extends StatelessWidget {
 ...
 Widget build(BuildContext context) {
  ...
  final isDarkMode = theme.brightness == Brightness.dark;
   return ViewModelBuilder<OutcomeViewModel>.reactive(
     builder: (context, model, child) => Scaffold(
        backgroundColor: XColors.PRIMARY,
        appBar: AppBar(
          backgroundColor: XColors.TRANSPARENT,
          title: const Text('Add Outcome', style: TextStyle(color: XColors.WHITE)),
          leading: IconButton(
     ...
     viewModelBuilder: () => OutcomeViewModel(),
   );
 }
}